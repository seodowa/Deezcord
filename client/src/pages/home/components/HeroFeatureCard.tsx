...
export default function HeroFeatureCard({ isNewUser, onExplore }: HeroFeatureCardProps) {
  return (
    <div className="relative group overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-indigo-600 to-blue-700 p-1 shadow-2xl shadow-blue-500/20">
      ...
      <div className="relative bg-white/5 backdrop-blur-3xl rounded-[2.4rem] p-6 md:p-8 flex flex-col md:flex-row items-center gap-8">
        <div className="w-24 h-24 md:w-32 md:h-32 rounded-[2rem] bg-white/10 backdrop-blur-2xl border border-white/20 flex items-center justify-center shadow-2xl relative group-hover:rotate-3 transition-transform duration-500 shrink-0">
        ...
        <div className="flex-1 text-center md:text-left space-y-4">
          ...
          <div className="flex justify-center md:justify-start">
            <button 
              onClick={onExplore}
              className="px-6 py-3 bg-white text-indigo-600 rounded-xl font-bold text-sm shadow-xl shadow-white/10 hover:scale-105 active:scale-95 transition-all duration-300"
            >

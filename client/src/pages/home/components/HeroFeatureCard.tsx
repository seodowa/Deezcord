...
export default function HeroFeatureCard({ isNewUser, onExplore }: HeroFeatureCardProps) {
  return (
    <div className="relative group overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-indigo-600 to-blue-700 dark:from-slate-900 dark:to-indigo-950 p-1 shadow-2xl shadow-blue-500/20 dark:shadow-indigo-950/40 border border-transparent dark:border-white/5">
